...
### 安装目标
![055](./img/055.png)
1. 这是需要**安装和调试**的交付清单。（例如：需要安装、创建清单和客户检查的设备。）
1. （如果需要将**安装**更改为**非安装**）点击部件名称。
1. （如果需要将**安装**更改为**非安装**）取消选中“安装和调试需要安装**”。
1. （如果需要将**安装**更改为**非安装**）点击“刷新”。
<br/>
<br/>

### 非安装目标
![056](./img/056.png)
1. 这是无需安装和调试的交付清单。<br/>(例如：馈线等资产，它们按序列号进行保修管理，但仅进行交付。）
1. (如果需要选择安装目标）点击部件名称。
1. (如果需要选择安装目标）安装过程中请确认驱动器目标。
1. (如果需要选择安装目标）点击刷新。
<br/>
<br/>
