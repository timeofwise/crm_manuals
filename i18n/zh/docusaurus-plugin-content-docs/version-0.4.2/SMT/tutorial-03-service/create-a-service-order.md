...
1. 单击“保存”以反映资产。
    :::info **注册其他中心资产服务**
    - 未分配到用户中心的资产也可以注册此服务。在此过程中，您可以确认资产的分配中心，并在必要时选择是否将分配中心转移到用户中心。
    - 注册资产时，还必须选择是否将其转移到相应的中心。选项如下：
        - **不转移资产直接进入下一步**：资产所有权或管理主体不变，仅服务继续。
        - **转移资产至00并进入下一步**：资产所有权和管理主体将转移至服务注册管理器中心。
    :::
<br/>
<br/>
