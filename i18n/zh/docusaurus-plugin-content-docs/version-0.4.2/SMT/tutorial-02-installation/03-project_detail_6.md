...
1. 工人可以处理已完成的任务。
    :::info
    **订单创建者**和**服务经理**可以处理工作完成情况。
    :::
1. （管理员）检查工程师完成的安装工作后，点击管理员批准按钮。
    :::warning
    已经由管理员批准的项目不能被修改。 
    :::
<br/>
...
## 安装目标
:::warning
如果安装目标不存在，请进入**概览**选项卡，检查**交付列表**是否正常注册。
:::
![025](./img/025.png)
...
1. 点击**确认**按钮结束安装试运行。
    ...
    <br/>如果电子签名不具有法律效力，例如在**中国**，请附上可以替代签名的可信文件。
    :::
    :::warning
