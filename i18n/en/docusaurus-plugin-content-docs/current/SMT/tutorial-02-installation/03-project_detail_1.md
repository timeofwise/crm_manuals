...
<br/>Only assets added to the **Installation Assets** of the **Delivery List** will be subject to **Installation**.


### Queue
:::info
There is no queue when adding assets directly.
:::
...
### Installtion Asset(s)
![055](./img/055.png)
1. This is the list of deliveries that are subject to **installation and commissioning**. (Example: Equipment requiring installation, checklist creation, and customer inspection.)
:::info
If **installation** is required to be changed to **non-installation target**.
1. Click the part name.
1. Uncheck the **Installation target**.
1. Click Refresh.
:::
<br/>
<br/>

### Non-Installation Asset(s)
![056](./img/056.png)
1. This is a list of deliveries that are not subject to installation and commissioning. <br/>(Example: Assets like feeders, which are managed under warranty by serial number but are simply delivered.)
:::info
If you need to change to **installation target**.
1. Click the part name.
1. Check the **Installation Target**.
1. Click Refresh.
:::
<br/>
<br/>
