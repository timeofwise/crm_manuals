...
import email from "./img/019.png";
import popup1 from "./img/039.png";
import process from "./img/041.png";

# 교육 관리

온라인 및 집합 **교육 과정 생성**부터 **교육장 정보 관리**, **수강자 현황 확인** 및 교육 **만족도 조사 발송**까지 교육 전반에 걸친 관리 방법을 안내합니다.
...
### 목록
![018](./img/018.png)
1. 온라인 교육과정 및 코스를 관리 할 수 있는 탭 입니다.
    :::info
    <div><img src={process} width="60%" alt="041" /></div>
    **하나의 교육 과정 안에 여러개의 코스를 개설** 할 수 있습니다.
    :::
1. **교육과정 관리** 버튼을 클릭 시, 교육과정 관리 모달이 나타납니다. 교육과정을 등록, 수정, 삭제할 수 있습니다. 
1. **수강자 관리** 버튼을 클릭 시, **온라인 수강자 관리** 페이지로 이동합니다. <br/>해당 페이지에서 수강자에게 **교육 만족도 조사 링크를 발송** 할 수 있습니다.
...
1. **추가** 버튼을 클릭하여 교육 코스를 신규 등록할 수 있습니다.
    :::warning
    교육과정 추가는 **교육과정 관리** 버튼을 클릭하여 진행하십시오.
    :::
...
### 교육 코스 이메일 전송
![038](./img/038.png)
1. 온라인 교육을 1개 선택 후, **이메일전송** 버튼을 클릭하여 코스 상세 링크를 이메일로 전송할 수 있습니다. <br/>이때 보내지는 링크는 **교육코스 상세** 즉, 수강신청을 할 수 있는 페이지입니다. 
<br/>
<br/>
<div><img src={email} width="40%" alt="019" /></div>

1. **교육코스 명** 및 교육코스 페이지의 **링크**가 표시됩니다. <br/>이때 코스 선택은 [업무메뉴관리 > 온라인 교육관리]에서 하지만, 첨부되는 링크는 사용자단의 코스 상세입니다. 링크를 전송받은 사용자가 코스를 둘러보고, 수강신청을 할 수 있게 하기 위해서 입니다. <br/>유효기간을 선택 할 수 있습니다. 링크를 전송받은 사용자는 **유효기간 내에 링크를 통해 교육코스 상세**에 접근할 수 있습니다.
1. **검색** 탭을 선택 시, 한화 그룹웨어 내에 존재하는 이름, 이메일을 검색할 수 있습니다. 
    :::info
    <div><img src={popup1} width="40%" alt="039" /></div>
    **직접입력** 탭을 선택 시, 링크를 공유하고 싶은 이메일을 자유롭게 입력할 수 있습니다. <br/>이메일을 입력 후, **추가** 버튼 클릭 시, 목록에 추가됩니다. 
    :::
1. 이름 또는 이메일 검색하면 일치하는 항목이 드롭다운에 표시됩니다. 선택 시, 하단 목록에 추가됩니다. 
    :::tip
    검색창 하단에 이메일을 전송받을 사용자 목록이 표시됩니다.<br/>**그룹웨어에서 검색한 사용자는 이름, 직책, 이메일이 표시**되고 직접입력한 경우 이메일만 표시됩니다. <br/>**X 버튼**을 클릭하여 사용자를 삭제할 수 있습니다.
    :::
1. **전송** 버튼 클릭 시, 사용자들에게 **교육코스 상세 링크가 이메일로 전송**됩니다. 
<br/>
<br/>

### 교육 코스 신규 등록
![040](./img/040.png)
1. 신규 교육과정 등록을 위하여 **+** 버튼을 클릭합니다.
<br/>
<br/>

![020](./img/020.png)
1. 교육 코스가 등록될 **교육과정을 선택**할 수 있습니다.
...
1. [**강의관리**](#강의관리---커리큘럼-등록--수정) 버튼을 클릭하여 강의 관리 페이지로 이동할 수 있습니다. 수정사항을 저장하지 않을 시, 저장이 되지 않고 이동됩니다.
1. 교육 코스 수정 후 **저장** 버튼을 클릭하여 저장합니다. 
<br/>
<br/>
...
![023](./img/023.png)
:::info
커리큘럼을 추가하는 방법을 안내합니다. 기존에 생성된 **커리큘럼을 수정하려면 해당 항목을 클릭**하여 수정 후 **저장** 합니다.
:::
1. 커리큘럼 추가를 선택합니다. 
1. 코스 등록시 선택한 언어가 강의관리 페이지에도 선택되어 있습니다. 커리큘럼명을 입력합니다.
    :::tip
    - 강의관리에서는 별도의 언어선택이 불가하며 해당 언어의 강의가 준비되어있지 않더라도 커리큘럼명은 생성해두어야 합니다. 
    :::
1. [저장] 버튼을 클릭하여 커리큘럼을 등록합니다.
<br/>
<br/>
...
1. **강의 추가**를 선택합니다. 
    ...
    :::
1. **커리큘럼**을 선택합니다. 선택한 커리큘럼 밑에 강의가 추가됩니다.
1. **동영상** 파일을 **첨부**합니다. 
1. 수강자에게 전달할 **강의정보**를 입력합니다.
1. **등록** 버튼을 클릭하여 강의를 등록합니다. 
1. 드래그 아이콘을 클릭 후, 드래그하여 커리큘럼내에서 **강의순서를 조절**할 수 있습니다. 
<br/>
<br/>

### 수강자 관리
![042](./img/042.png)
1. 교육관리의 온라인탭에서 **수강자 관리** 버튼을 클릭합니다. 
<br/>
<br/>
