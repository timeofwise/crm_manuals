...
## 소요시간
![059](./img/059.png)
1. 작업에 할애된 소요시간을 추가 할 수 있습니다..
1. 작업자는 작업 완료 처리를 할 수 있습니다. 
    :::info
    작업완료 처리는 해당 **오더 작성자**와, **서비스 관리자**가 가능합니다.
    :::
1. 관리자는 작업자의 소요 시간을 확인하고 관리자 승인을 할 수 있습니다. 
    :::warning
    관리자 승인이 완료된 항목은 수정이 불가합니다. 
    :::
...
## 설치 대상
:::warning
설치 대상이 존재하지 않는 경우에는 **개요**탭으로 이동하여 **납품목록**이 정상적으로 등록되어있는지 확인합니다. 
:::
![025](./img/025.png)
1. 설치 대상을 클릭합니다.
