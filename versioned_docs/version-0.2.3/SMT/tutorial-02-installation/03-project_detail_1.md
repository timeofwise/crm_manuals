...
<br/>**납품목록**의 **설치대상**에 추가된 자산만이 **설치시운전 대상**이 됩니다. 

### 대기열
:::info
직접 자산을 추가하는 경우에는 대기열이 존재하지 않습니다.
:::
...
### 설치 대상
![055](./img/055.png)
1. **설치시운전 대상**이 되는 납품 목록입니다. (예시 : 설치 및 체크리스트 작성과 고객 검수가 필요한 설비류)
1. (설치 **비대상으로 바꿔야 하는 경우**) 부품명을 클릭합니다. 
1. (설치 **비대상으로 바꿔야 하는 경우**) 설치시운전 설치대상을 체크 해제합니다. 
1. (설치 **비대상으로 바꿔야 하는 경우**) 새로고침을 클릭합니다. 
<br/>
<br/>

### 설치 비대상
![056](./img/056.png)
1. 설치시운전 **대상이 아닌** 납품 목록입니다. <br/>(예시 : 시리얼번호로 자산회되어 보증기간 관리가 되나, 단순 납품처리가 되는 피더와같은 자산)
1. (설치 **대상으로 바꿔야 하는 경우**) 부품명을 클릭합니다.
1. (설치 **대상으로 바꿔야 하는 경우**) 설치시운전 설치대상 체크합니다. 
1. (설치 **대상으로 바꿔야 하는 경우**) 새로고침 클릭합니다.
<br/>
<br/>
