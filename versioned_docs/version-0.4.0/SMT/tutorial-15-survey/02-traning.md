...
### 설문지 관리 - 설문 대상
![007](./img/007.png)
1. 수강자를 선택 후, [**이메일** 버튼](#만족도-조사-링크-전송)을 클릭합니다. 수강자에게 설문조사를 전송 할 수 있습니다. 
1. [**설문대상**](#수신처-추가)을 추가 할 수 있습니다. 
...
#### 만족도 조사 링크 전송
<div><img src={Popup3} width="60%" alt="008" /></div>
:::warning
...
#### 수신처 추가
<div><img src={Popup2} width="60%" alt="009" /></div>

1. 수신 대상을 **검색**합니다. <br/>H-CRM 가입자, Circle 사용자를 선택하거나 대상자 정보를 직접 입력 할 수 있습니다.
    <br/>* 설문 대상을 직접 입력할 경우 엑셀 양식을 다운받아 양식에 맞게 작성합니다. 
    <br/> 국가코드 및 휴대폰번호를 아래와같이 작성하여야 정상적으로 문자가 발송됩니다.
    :::info
    **예시) 국가코드 : 82, 휴대폰번호 : 01012345678**
    <br/> 
    ![016](./img/016.png)
    :::
1. 대상자를 **선택**합니다. 
