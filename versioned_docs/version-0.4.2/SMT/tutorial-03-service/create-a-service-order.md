...
import Popup1 from "./img/031.png";

# 서비스 접수
고객사의 서비스 요청이 있는 경우 서비스를 접수하고 처리하기 위한 절차를 안내합니다.
...
1. 저장을 눌러 해당 자산을 반영합니다. 
    :::info **타 센터 자산 서비스 등록**
    - 사용자의 센터에 소속되지 않은 자산도 서비스 등록이 가능합니다. 이 과정에서 자산의 담당 센터를 확인할 수 있으며, 필요에 따라 담당 센터를 사용자 센터로 이관할지 여부를 선택할 수 있습니다.
    <div><img src={Popup1} width="50%" alt="031" /></div>
    - 자산 등록 시 담당 센터 이관 여부를 선택하세요.
        - **자산을 이관하지 않고 다음 단계로 진행합니다** : 자산의 소유권이나 관리 주체는 변경되지 않고 서비스만 진행됩니다.
        - **자산을 00로 이관하고 다음 단계로 진행합니다** : 자산의 소유권 및 관리 주체가 서비스 등록 담당자의 센터로 변경됩니다.  
    :::
<br/>
<br/>
...
![003](./img/003.png)
:::info
[위 단계](#서비스-접수---14)에서 자산이 선택 되면, 해당 자산을 보유한 고객사 정보가 자동으로 입력됩니다. <br/>고객사 등록은 자산과 연결되어있는 고객사 정보가 변경되었을 경우에만 진행합니다.
:::
1. **선택**을 눌러 고객사 정보를 등록합니다. 
    :::warning
    **고객사 등록 전** 서비스 대상 설비 또는 자산을 등록해야 합니다. 
    :::
1. 고객사 명을 검색하여 저장합니다.
