...
# VOC 처리
VOC 처리 및 관리자들을 대상으로 등록된 VOC 요청건에 대한 검토와 후속 작업에 대해 안내합니다.
<ValidateTextByToken dispTargetViewer={true} dispCaution={true} validTokenList={['head']}>

## VOC 접수 조회
### 이메일을 통한 조회
![008](./img/008.png)
1. 수신된 VOC 알림 메일의 **링크를 클릭**합니다.
<br/>
<br/>
...
![009](./img/009.png)
1. **VOC** 메뉴를 클릭합니다. 
2. VOC 목록 중, 작업을 수행할 VOC의 ID를 클릭합니다. 
<br/>
<br/>
...
1. 최근의 **설비 MMI화면의 QR코드** 스캔 이력 정보를 표시합니다. 
    ...
    :::
1. 버튼을 클릭시 CRM 시스템의 언어에 맞게 번역 결과를 표시합니다.
<br/>
<br/>
...
## VOC 승인 / 기각
:::info
접수된 VOC에 대하여 **VOC 관리자의** 승인 또는 기각 방법을 안내합니다.
:::
![012](./img/012.png) 
1. 해당 VOC를 승인할 예정인 경우, 등록된 VOC의 체계적인 관리를 위하여 필수 필드 값을 추가합니다.
...
1. VOC에 대한 접수의견을 입력합니다.
1. **승인** 버튼을 눌러 승인합니다. 승인시, 접수자에게 아래와 같은 이메일이 발송됩니다.
    :::info 승인 메일
    <div>![014](./img/014.png)</div>
    :::
1. VOC를 기각해야 할 경우 **기각** 버튼을 눌러 기각합니다. 기각시, 접수자에게 아래와 같은 이메일이 발송됩니다.
    :::warning 기각 메일
