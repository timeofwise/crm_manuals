...
1. 4가지 유형의 주문서 생성 방식 중에서 1가지를 선택합니다.
    - 서비스 연계주문 : CRM에 관련된 서비스가 이미 등록되어있는 경우, 서비스 주문서에 사용된 부품을 주문시 (특히 무상자재 요청시) 활용합니다.
    - 일반주문: CRM에 별도의 서비스가 등록되어있지 않는 일반 유상 PO 생성 시 사용합니다.
    - 구매품의: **법인**의 유상 PO 생성시 사용하는 메뉴입니다.
