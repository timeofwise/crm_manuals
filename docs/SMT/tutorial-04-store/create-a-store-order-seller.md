...
:::info
판매권한을 갖고있는 담당자만 보이는 메뉴입니다. **본사, 법인 및 대리점(자재거점)의 자재 담당자**에 해당합니다. 
:::
...
1. [**PO**](#po) :접수된 주문을 **PO 단위로 관리**하는 페이지 입니다. 전체 PO에 대한 진행 현황을 파악하여 관리 할 수 있습니다. 
1. [**Item**](#item) : PO에 포함된 **부품 단위로 주문 접수 내역을 관리** 할 수 있습니다. PO가 미결인 경우 미결 원인이 되는 부품이 무엇인지 쉽게 파악할 수 있습니다. 
...
1. **주문번호**를 클릭하여 PO의 상세 페이지로 이동 할 수 있습니다.  PO 상세 페이지는 [**주문서 상세**](#주문서-상세) 내용과 동일합니다. 
...
1. 주문 아이템을 정보가 표시됩니다. 
    ...
    2. **Storate Location**을 선택하여 특정 자재 창고의 재고 확인이 가능합니다. 
    3. 주문 목록의 **엑셀 출력**이 가능합니다.
    :::
4. 내용 확인이 끝나면, 주문서의 승인여부를 선택합니다. 
...
5. 관련하여 구매자의 여신 정보를 확인 할 수 있습니다.
<br/>
<br/>
...
1. [**PO 취소**](#po-취소) : 주문 정보의 유무상 구분 변경 등의 사유가 있는 경우, PO 취소를 할 수 있습니다. 
    :::info 주문 정보의 유무상 변경 등의 사유가 있는 경우, PO 취소를 할 수 있습니다. 
