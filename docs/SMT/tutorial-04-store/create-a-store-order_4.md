...
## 기본사항 입력
![025](./img/025.png)
- 비고란에 비고사항을 입력하고 **주문자(기안자) 정보**를 확인합니다.
<br/>
<br/>

## 추가정보 입력
![026](./img/026.png)
1. 고객사 정보를 입력할 필요가 없다면 **고객사 없음 토글 버튼을 활성화**합니다.
    :::tip
    교육센터에서의 자재 주문 등의 경우 고객사 없음을 선택합니다.
    :::
1. 고객사 정보를 **선택** 버튼을 눌러 불러옵니다. (필수값) - [고객사 선택 화면 보기](#추가정보-입력---고객사-선택)
1. 고객사의 담당자 정보를 **선택** 버튼을 눌러 불러옵니다. (옵션값) - [고객담당자 선택 화면 보기](#추가정보-입력---고객담당자-선택)
<br/>
<br/>
